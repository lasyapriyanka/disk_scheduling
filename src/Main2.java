...
//	public static int head;
	...
	public void init(){
		...
		btnNewButton.setBounds(24, 450, 97, 25);
		...
		btnNewButton_1.setBounds(345, 450, 97, 25);
		...
		btnCscan.setBounds(238, 450, 97, 25);
		...
		btnStsf.setBounds(131, 450, 97, 25);
		...
		btnScan.setBounds(452, 450, 97, 25);
		...
		btnClook.setBounds(559, 450, 97, 25);
		getContentPane().add(btnClook);
		
		JLabel lblHead = new JLabel("head");
		lblHead.setBounds(559, 55, 56, 16);
		...
		lblSixth.setBounds(373, 385, 56, 16);
		...
		textField_2.setBounds(242, 355, 116, 22);
		getContentPane().add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(418, 352, 116, 22);
		getContentPane().add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(67, 385, 116, 22);
		...
		textField_6.setBounds(418, 385, 116, 22);
		getContentPane().add(textField_6);
		
		JLabel lblEnd = new JLabel("end");
		lblEnd.setBounds(559, 115, 56, 16);
		getContentPane().add(lblEnd);
		
		textField_7 = new JTextField();
		textField_7.setColumns(10);
		textField_7.setBounds(609, 112, 47, 22);
		getContentPane().add(textField_7);
		
		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setBounds(609, 82, 47, 22);
		getContentPane().add(textField_8);
		
		JLabel lblStart = new JLabel("start");
		lblStart.setBounds(559, 88, 56, 16);
		getContentPane().add(lblStart);
		
		JLabel lblChooseSchedulingAlgorithm = new JLabel("Choose Scheduling Algorithm");
		lblChooseSchedulingAlgorithm.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblChooseSchedulingAlgorithm.setBounds(195, 417, 272, 35);
		getContentPane().add(lblChooseSchedulingAlgorithm);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(609, 49, 47, 22);
		getContentPane().add(textField);
		
		JLabel lblEnterValues = new JLabel("Enter Values");
		lblEnterValues.setFont(new Font("Sitka Small", Font.PLAIN, 18));
		lblEnterValues.setBounds(544, 358, 112, 52);
		getContentPane().add(lblEnterValues);
}
